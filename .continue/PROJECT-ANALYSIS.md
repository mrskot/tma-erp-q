...
- ✅ **Заявки (90%):** Реализовано пакетное создание заявок, фильтрация по статусам, удаление. Поле "Заметки" интегрировано с БД.
- ✅ **Стабилизация UI (100%):** Улучшена обработка ошибок (подробная валидация), исправлены ссылки на API.

### Что нужно доделать:

1. **Несоответствия**
   - [ ] Реализовать интерфейс для работы с несоответствиями.
2. **Dashboard**
